...
import (
	...
	"code.cloudfoundry.org/diego-release/dockerapplifecycle"
	"code.cloudfoundry.org/diego-release/dockerapplifecycle/helpers"
	"code.cloudfoundry.org/diego-release/dockerapplifecycle/protocol"
...
`
	...
	Describe("FetchMetadata", func() {
		...
		JustBeforeEach(func() {
			fixturesPath := path.Join(os.Getenv("DIEGO_RELEASE_DIR"), "src/code.cloudfoundry.org/diego-release/dockerapplifecycle/helpers/fixtures")
