...
import (
	...
	route_emitter "code.cloudfoundry.org/diego-release/route-emitter"
	"code.cloudfoundry.org/diego-release/route-emitter/cmd/route-emitter/config"
	"code.cloudfoundry.org/diego-release/route-emitter/consuldownchecker"
	"code.cloudfoundry.org/diego-release/route-emitter/consuldownmodenotifier"
	"code.cloudfoundry.org/diego-release/route-emitter/diegonats"
	"code.cloudfoundry.org/diego-release/route-emitter/emitter"
	"code.cloudfoundry.org/diego-release/route-emitter/routehandlers"
	"code.cloudfoundry.org/diego-release/route-emitter/routingtable"
	"code.cloudfoundry.org/diego-release/route-emitter/scheduler"
	"code.cloudfoundry.org/diego-release/route-emitter/syncer"
	"code.cloudfoundry.org/diego-release/route-emitter/unregistration"
	"code.cloudfoundry.org/diego-release/route-emitter/watcher"
