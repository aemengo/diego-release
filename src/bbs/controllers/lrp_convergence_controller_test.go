...
import (
	...
	"code.cloudfoundry.org/diego-release/auctioneer/auctioneerfakes"
	"code.cloudfoundry.org/diego-release/bbs/controllers"
	"code.cloudfoundry.org/diego-release/bbs/controllers/fakes"
	"code.cloudfoundry.org/diego-release/bbs/db"
	"code.cloudfoundry.org/diego-release/bbs/db/dbfakes"
	"code.cloudfoundry.org/diego-release/bbs/events/eventfakes"
	mfakes "code.cloudfoundry.org/diego-release/bbs/metrics/fakes"
	"code.cloudfoundry.org/diego-release/bbs/models"
	"code.cloudfoundry.org/diego-release/bbs/models/test/model_helpers"
	"code.cloudfoundry.org/diego-release/bbs/serviceclient/serviceclientfakes"
	"code.cloudfoundry.org/clock/fakeclock"
	"code.cloudfoundry.org/lager"
	"code.cloudfoundry.org/lager/lagertest"
	"code.cloudfoundry.org/diego-release/rep/repfakes"
