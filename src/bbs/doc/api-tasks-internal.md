...
POST a [StartTaskRequest](https://godoc.org/code.cloudfoundry.org/diego-release/bbs/models#StartTaskRequest)
to `/v1/tasks/start`
and receive a [StartTaskResponse](https://godoc.org/code.cloudfoundry.org/diego-release/bbs/models#StartTaskResponse).
...
POST a [FailTaskRequest](https://godoc.org/code.cloudfoundry.org/diego-release/bbs/models#FailTaskRequest)
to `/v1/tasks/fail`
and receive a [TaskLifecycleResponse](https://godoc.org/code.cloudfoundry.org/diego-release/bbs/models#TaskLifecycleResponse).
...
POST a [RejectTaskRequest](https://godoc.org/code.cloudfoundry.org/diego-release/bbs/models#RejectTaskRequest)
to `/v1/tasks/reject`
and receive a [TaskLifecycleResponse](https://godoc.org/code.cloudfoundry.org/diego-release/bbs/models#TaskLifecycleResponse).
...
### BBS API Endpoint
POST a [CompleteTaskRequest](https://godoc.org/code.cloudfoundry.org/diego-release/bbs/models#CompleteTaskRequest)
to `/v1/tasks/fail`
and receive a [TaskLifecycleResponse](https://godoc.org/code.cloudfoundry.org/diego-release/bbs/models#TaskLifecycleResponse).
