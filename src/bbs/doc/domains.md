...
POST an
[UpsertDomainRequest](https://godoc.org/code.cloudfoundry.org/diego-release/bbs/models#UpsertDomainRequest)
to `/v1/domains/upsert`, and receive an
[UpsertDomainResponse](https://godoc.org/code.cloudfoundry.org/diego-release/bbs/models#UpsertDomainResponse).
...
[DomainsResponse](https://godoc.org/code.cloudfoundry.org/diego-release/bbs/models#DomainsResponse).
