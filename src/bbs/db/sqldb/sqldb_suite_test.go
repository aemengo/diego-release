...
import (
	...
	thepackagedb "code.cloudfoundry.org/diego-release/bbs/db"
	...
	"code.cloudfoundry.org/diego-release/bbs/format"
	"code.cloudfoundry.org/diego-release/bbs/guidprovider/guidproviderfakes"
