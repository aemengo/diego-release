...
var _ = SynchronizedBeforeSuite(
	func() []byte {
		bbsPath, err := gexec.Build("code.cloudfoundry.org/diego-release/bbs/cmd/bbs", "-race")
...
var _ = BeforeEach(func() {
	...
	fixturesPath := path.Join(os.Getenv("DIEGO_RELEASE_DIR"), "src/code.cloudfoundry.org/diego-release/bbs/cmd/bbs/fixtures")
