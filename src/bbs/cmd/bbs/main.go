...
import (
	...
	"code.cloudfoundry.org/diego-release/bbs/cmd/bbs/config"
	"code.cloudfoundry.org/diego-release/bbs/controllers"
	"code.cloudfoundry.org/diego-release/bbs/converger"
	"code.cloudfoundry.org/diego-release/bbs/db/migrations"
	"code.cloudfoundry.org/diego-release/bbs/db/sqldb"
	"code.cloudfoundry.org/diego-release/bbs/db/sqldb/helpers"
	"code.cloudfoundry.org/diego-release/bbs/db/sqldb/helpers/monitor"
	"code.cloudfoundry.org/diego-release/bbs/encryption"
	"code.cloudfoundry.org/diego-release/bbs/encryptor"
	"code.cloudfoundry.org/diego-release/bbs/events"
	"code.cloudfoundry.org/diego-release/bbs/guidprovider"
	"code.cloudfoundry.org/diego-release/bbs/handlers"
	"code.cloudfoundry.org/diego-release/bbs/metrics"
	"code.cloudfoundry.org/diego-release/bbs/migration"
	"code.cloudfoundry.org/diego-release/bbs/models"
	"code.cloudfoundry.org/diego-release/bbs/serviceclient"
	...
	"code.cloudfoundry.org/diego-release/locket/jointlock"
	"code.cloudfoundry.org/diego-release/locket/lock"
	"code.cloudfoundry.org/diego-release/locket/lockheldmetrics"
	locketmodels "code.cloudfoundry.org/diego-release/locket/models"
	"code.cloudfoundry.org/diego-release/rep"
	"code.cloudfoundry.org/diego-release/rep/maintain"
