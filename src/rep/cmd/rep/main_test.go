...
import (
	...
	"code.cloudfoundry.org/diego-release/rep/cmd/rep/testrunner"
...
var _ = Describe("The Rep", func() {
	...
	BeforeEach(func() {
		basePath = path.Join(os.Getenv("DIEGO_RELEASE_DIR"), "src/code.cloudfoundry.org/diego-release/rep/cmd/rep/fixtures")
