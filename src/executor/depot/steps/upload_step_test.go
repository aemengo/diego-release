...
import (
	...
	"code.cloudfoundry.org/diego-release/executor/depot/log_streamer/fake_log_streamer"
	"code.cloudfoundry.org/diego-release/executor/depot/steps"
	Uploader "code.cloudfoundry.org/diego-release/executor/depot/uploader"
	"code.cloudfoundry.org/diego-release/executor/depot/uploader/fake_uploader"
