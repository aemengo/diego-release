...
import (
	...
	"code.cloudfoundry.org/diego-release/executor/depot/containerstore/containerstorefakes"
	eventfakes "code.cloudfoundry.org/diego-release/executor/depot/event/fakes"
	"code.cloudfoundry.org/diego-release/executor/depot/log_streamer"
	"code.cloudfoundry.org/diego-release/executor/depot/steps"
	"code.cloudfoundry.org/diego-release/executor/depot/transformer"
	"code.cloudfoundry.org/diego-release/executor/depot/transformer/faketransformer"
	"code.cloudfoundry.org/diego-release/executor/initializer/configuration/configurationfakes"
