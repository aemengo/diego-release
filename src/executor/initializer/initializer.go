...
import (
	...
	"code.cloudfoundry.org/diego-release/executor/depot"
	"code.cloudfoundry.org/diego-release/executor/depot/containerstore"
	"code.cloudfoundry.org/diego-release/executor/depot/event"
	"code.cloudfoundry.org/diego-release/executor/depot/metrics"
	"code.cloudfoundry.org/diego-release/executor/depot/transformer"
	"code.cloudfoundry.org/diego-release/executor/depot/uploader"
	"code.cloudfoundry.org/diego-release/executor/gardenhealth"
	"code.cloudfoundry.org/diego-release/executor/guidgen"
	"code.cloudfoundry.org/diego-release/executor/initializer/configuration"
