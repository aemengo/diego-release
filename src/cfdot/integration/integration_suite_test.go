...
import (
	...
	"code.cloudfoundry.org/diego-release/locket/cmd/locket/testrunner"
...
var _ = SynchronizedBeforeSuite(func() []byte {
	binPath, err := gexec.Build("code.cloudfoundry.org/diego-release/cfdot")
	Expect(err).NotTo(HaveOccurred())

	locketBinPath, err := gexec.Build("code.cloudfoundry.org/diego-release/locket/cmd/locket")
	Expect(err).NotTo(HaveOccurred())
