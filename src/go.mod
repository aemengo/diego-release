...
require (
	...
	code.cloudfoundry.org/auction v0.0.0-20210519165727-96d7bdfd7ee8
	...
	code.cloudfoundry.org/eventhub v0.0.0-20200131001618-613224898d70 // indirect
	code.cloudfoundry.org/executor v0.0.0-20210512135645-c26d5d5f7fc4
	...
	code.cloudfoundry.org/volman v0.0.0-20200131000528-de20a3b4bade // indirect
