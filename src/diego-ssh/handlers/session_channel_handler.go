...
import (
	...
	"code.cloudfoundry.org/diego-release/diego-ssh/scp"
	"code.cloudfoundry.org/diego-release/diego-ssh/signals"
	"code.cloudfoundry.org/diego-release/diego-ssh/termcodes"
