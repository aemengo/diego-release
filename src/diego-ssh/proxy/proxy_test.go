...
import (
	...
	"code.cloudfoundry.org/diego-release/diego-ssh/authenticators/fake_authenticators"
	"code.cloudfoundry.org/diego-release/diego-ssh/daemon"
	"code.cloudfoundry.org/diego-release/diego-ssh/handlers"
	"code.cloudfoundry.org/diego-release/diego-ssh/handlers/fake_handlers"
	"code.cloudfoundry.org/diego-release/diego-ssh/helpers"
	"code.cloudfoundry.org/diego-release/diego-ssh/proxy"
	"code.cloudfoundry.org/diego-release/diego-ssh/server"
	server_fakes "code.cloudfoundry.org/diego-release/diego-ssh/server/fakes"
	"code.cloudfoundry.org/diego-release/diego-ssh/test_helpers"
	"code.cloudfoundry.org/diego-release/diego-ssh/test_helpers/fake_net"
	"code.cloudfoundry.org/diego-release/diego-ssh/test_helpers/fake_ssh"
