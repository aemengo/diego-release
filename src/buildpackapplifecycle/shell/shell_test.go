...
import (
	...
	"code.cloudfoundry.org/diego-release/buildpackapplifecycle/shell"
...
var _ = Describe("Shell", func() {
	Describe("[integration]", func() {
		...
		BeforeEach(func() {
			shellPath, err := gexec.Build("code.cloudfoundry.org/diego-release/buildpackapplifecycle/shell/shell", "-race")
